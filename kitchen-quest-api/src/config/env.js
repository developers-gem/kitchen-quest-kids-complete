...
const envSchema = z.object({
  ...
  // OPTIONAL. SMTP credentials for real email delivery (SendGrid, Postmark, SES, etc.)
  // If unset, email.service.js safely falls back to mock console logs without failing.
  ...
  // OPTIONAL. Error tracking (Sentry) and Redis shared rate limiting
  SENTRY_DSN: z.string().optional(),
  REDIS_URL: z.string().optional(),
});
